...
//ACS712 sensor(ACS712, 13);
ACS712  ACS(13, 3.3, 4095, 185); //  ACS712 5A  uses 185 mV per A
...
{
  loop();
  server.send(200, "text/html", SendHTML(SOL_VOLTAGE, BAT_CURRENT, PID_TEMP, BAT_VOLTAGE));
}
...
String SendHTML(float SOL_VOLTAGE, float BAT_CURRENT, float PID_TEMP, float BAT_VOLTAGE)
{
  ...
  ptr += "<meta content=\"Advait Thale\" name=\"author\"><meta content=\"2\" http-equiv=\"refresh\">\n";
